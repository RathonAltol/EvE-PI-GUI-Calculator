...
class CalculationScreen(tk.Frame):
    def __init__(self, parent, controller):
        ...
        self.scrollable_frame.bind("<Enter>", lambda e: self.canvas.bind_all("<Button-4>", self._on_mousewheel_linux))
        self.scrollable_frame.bind("<Enter>", lambda e: self.canvas.bind_all("<Button-5>", self._on_mousewheel_linux))
        self.scrollable_frame.bind("<Leave>", lambda e: self.canvas.unbind_all("<Button-4>"))
        self.scrollable_frame.bind("<Leave>", lambda e: self.canvas.unbind_all("<Button-5>"))
