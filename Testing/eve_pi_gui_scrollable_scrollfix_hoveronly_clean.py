...
class CalculationScreen(tk.Frame):
    def __init__(self, parent, controller):
        ...
        # Mousewheel scroll over canvas/scrollable frame only
        self.canvas.bind("<Enter>", lambda e: self.canvas.bind_all("<MouseWheel>", self._on_mousewheel))
        self.canvas.bind("<Leave>", lambda e: self.canvas.unbind_all("<MouseWheel>"))
        self.canvas.bind("<Enter>", lambda e: self.canvas.bind_all("<Button-4>", self._on_mousewheel_linux))
        self.canvas.bind("<Enter>", lambda e: self.canvas.bind_all("<Button-5>", self._on_mousewheel_linux))
